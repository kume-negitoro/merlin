...
echo "QuestionFile=questions-japanese.hed" >> $global_config_file
...
echo "Train=4000" >> $global_config_file 
echo "Valid=500" >> $global_config_file 
echo "Test=500" >> $global_config_file 
echo "" >> $global_config_file
